...
app.use(
  cors({
    origin: process.env.FRONTEND_URL || "http://localhost:5173", // change to deployed front-end if needed
...
async function connectDB() {
  ...
  try {
    const uri =
      process.env.MONGO_URI || "mongodb://127.0.0.1:27017/loginDB";
...
/* ============================================================
   API ROUTES
============================================================ */
await registerRoutes(app); // your existing routes with login/register/products/etc.
